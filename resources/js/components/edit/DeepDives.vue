<template>
    <div>
        ...
        <button @click="removeDeepDive(deepdive, key)" class="btn btn-outline-danger float-right" v-if="deepdive.title"><i class="fas fa-trash"></i> Remove Deep Dive</button>
         ...
         <button @click="stage.deepdives.push({'title':{'placeholder':null}, 'text':{'placeholder':null}, 'id': uuidv4()})" class="btn btn-outline-primary"><i class="fas fa-image"></i> Add Deep Dive</button>
    </div>
