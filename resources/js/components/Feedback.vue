        ...
        <b-collapse id="collapse-feedback" class="mt-2">
            <div>
                ...
                <div class="form-group col-12">
                    <button type="submit" class="btn btn-primary" @click="submitFeedback">Submit Feedback</button>
    ...
    export default {
        ...
        methods: {
            submitFeedback: function() {
                axios.post("/feedback/" + this.tour.id, 
                { "name": this.name, "email": this.email, "feedback": this.feedback } 
                )
                .then(res => {
                    this.success = true;
                });
