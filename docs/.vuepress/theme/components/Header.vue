<template>
            ...
            <link rel="stylesheet" href="https://camino.cla.umn.edu/umn/css/2015-tc.css">
		...
		<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
			...
			<form class="umnhf umnhf-search" id="umnhf-h-search" action="//search.umn.edu/tc/" method="get" title="Search Websites and People" role="search">
...
export default {
    mounted() {
        ...
        umnhf.setAttribute('src',"https://camino.cla.umn.edu/umn/js/umnhf-2015.js");
